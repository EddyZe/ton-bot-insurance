...
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.Accounts;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.BalanceChange;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.DnsExpiring;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.FoundAccounts;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.PublicKey;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.accounts.Subscriptions;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.domain.DomainNames;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.events.AccountEvent;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.events.AccountEvents;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.jettons.JettonBalance;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.jettons.JettonsBalances;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.multisig.Multisigs;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.nft.NftItem;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.nft.NftItems;
import ru.eddyz.telegrambot.clients.tonapi.ton.schema.traces.TraceIds;
